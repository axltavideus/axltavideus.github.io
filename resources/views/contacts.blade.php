...
<div class="container py-5">
    ...
    <div class="row justify-content-center g-4">
        ...
        <div class="col-12 col-md-6">
            <a href="https://www.instagram.com/wensteintopup/" target="_blank" class="card contact-card h-100 text-decoration-none text-dark shadow-sm">
        ...
        <!-- WhatsApp Card -->
        <div class="col-12 col-md-6">
            <a href="https://wa.me/6285257291585" target="_blank" class="card contact-card h-100 text-decoration-none text-dark shadow-sm">
                <div class="card-body d-flex align-items-center gap-3">
